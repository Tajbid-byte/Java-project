...
private JButton createStyledButton(String text) {
    ...
    private JPanel settingsCategoriesPanel; // Class-level variable
...
private JPanel createSettingsPanel() {
    ...
    settingsCategoriesPanel = new JPanel();
...
private void resetToDefaultSettings() {
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        for (Component section : settingsCategoriesPanel.getComponents()) {
            if (section instanceof JPanel) {
                JPanel sectionPanel = (JPanel) section;
                for (Component row : sectionPanel.getComponents()) {
